...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Story.username'
        db.add_column('web_story', 'username', self.gf('django.db.models.fields.CharField')(default=None, max_length=30, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Story.username'
        db.delete_column('web_story', 'username')
